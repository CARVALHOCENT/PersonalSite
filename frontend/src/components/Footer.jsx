...
import { Mail, Github, Linkedin, Download, Heart } from 'lucide-react';
                ...
                <div className="grid md:grid-cols-2 gap-12 mb-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center group-hover:bg-gradient-to-r group-hover:from-cyan-500 group-hover:to-blue-500 transition-all">
